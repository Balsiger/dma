...
export class LanguageName extends Enum<LanguageName> {
  ...
  static readonly AQUAN = new LanguageName('Primordial (Aquan)', MonsterProto.Languages.Name.AQUAN);
  ...
  static readonly IGNAN = new LanguageName('Promordial (Ignan)', MonsterProto.Languages.Name.IGNAN);
