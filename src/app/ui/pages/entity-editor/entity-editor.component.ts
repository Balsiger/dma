...
import { AdventureEntity } from '../../../data/entities/static/adventure';
import { BattleMap } from '../../../data/entities/static/battle-map';
import { EncounterEntity } from '../../../data/entities/static/encounter-entity';
import { Event } from '../../../data/entities/static/event';
import { God } from '../../../data/entities/static/god';
import { Group } from '../../../data/entities/static/group';
...
import { Place } from '../../../data/entities/static/place';
import { Product } from '../../../data/entities/static/product';
import { EMPTY as EMPTY_PRODUCT_CONTENT, ProductContent } from '../../../data/entities/static/product-content';
