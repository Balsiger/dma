...
proto.dma.EncounterProto.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    monstersList: (f = jspb.Message.getRepeatedField(msg, 8)) == null ? undefined : f,
 ...
 * @return {!proto.dma.EncounterProto} returns this
 */
proto.dma.EncounterProto.prototype.addMonsters = function(value, opt_index) {
  return jspb.Message.addToRepeatedField(this, 8, value, opt_index);
};
 ...
 * @return {!proto.dma.EncounterProto} returns this
 */
proto.dma.EncounterProto.prototype.addItems = function(value, opt_index) {
  return jspb.Message.addToRepeatedField(this, 9, value, opt_index);
};
